        ...
        var a = t(window).width()
          ...
          , w = function() {
            for (var e = "", i = x(), s = 0; i > s; s++) {
                ...
                e += '<div class="pager-item"><a href="" data-slide-index="' + s + '" class="pager-link">' + n + "</a></div>"
            }
            o.pagerEl.html(e)
        }
          , T = function() {
            o.settings.pagerCustom ? o.pagerEl = t(o.settings.pagerCustom) : (o.pagerEl = t('<div class="pager" />'),
          ...
          , C = function() {
            o.controls.next = t('<a class="next" href="">' + o.settings.nextText + "</a>"),
            o.controls.prev = t('<a class="prev" href="">' + o.settings.prevText + "</a>"),
