...
$menu['menu300'] = array (
    ...
    array('300150', '배너관리', ''.G5_ADMIN_URL.'/admin_bbs/board.php?bo_table=banner', 'banner'),
    array('300200', '게시판그룹관리', ''.G5_ADMIN_URL.'/boardgroup_list.php', 'bbs_group'),
    array('300900', 'Products', ''.G5_ADMIN_URL.'/admin_bbs/board.php?bo_table=products', 'products'),
    array('300910', 'Download Center', ''.G5_ADMIN_URL.'/admin_bbs/board.php?bo_table=download', 'download'),
    array('300920', 'Press Release', ''.G5_ADMIN_URL.'/admin_bbs/board.php?bo_table=release', 'release'),
    array('300930', 'Online Inquiry', ''.G5_ADMIN_URL.'/admin_bbs/board.php?bo_table=inquiry', 'inquiry'),
	/*
