...
if ($board['bo_use_category']) {
    $is_category = true;
    $category_href = (G5_IS_ADMIN===true?G5_ADMBBS_URL:G5_BBS_URL).'/board.php?bo_table='.$bo_table;
...
$qstr = '&amp;'.$qstr;
$write_pages = get_paging(G5_IS_MOBILE ? $config['cf_mobile_pages'] : $config['cf_write_pages'], $page, $total_page, G5_ADMBBS_URL.'/board.php?bo_table='.$bo_table.$qstr.'&amp;page=');
